...
const defaultSettings = {
		...
		Looping: [
			{
				...
				value: false,
				onChange: ev => setSetting("enableLoop", ev.target.checked)
			},
			{
				type: "checkbox",
				id: "autoLoop",
				label: "Auto reset to loop start",
				value: true,
				onChange: ev => setSetting("autoLoop", ev.target.checked)
			},
			{
				type: "slider",
				id: "loopDelay",
				label: "Delay between loops (s)",
				value: 0,
				min: 0,
				max: 10,
				step: 1,
				onChange: value => setSetting("loopDelay", value)
			},
			{
				type: "slider",
				id: "loopStart",
				label: "Loop start (Measure #)",
				value: 0,
				min: 0,
				max: 9,
				step: 1,
				onChange: value => setSetting("loopStart", value)
			},
			{
				type: "slider",
				id: "loopEnd",
				label: "Loop end (Measure #)",
				value: 2,
				min: 1,
				max: 10,
				step: 1,
				onChange: value => setSetting("loopEnd", value)
			},
			{
				type: "checkbox",
				id: "muteLoop",
				label: "Mute notes outside of loop",
				value: true,
				onChange: ev => setSetting("muteLoop", ev.target.checked)
			}
		],
		"Sheet Music": [
			{
	...
	Video: {
		...
		Particles: [
			...
			{ type: "label", label: "Particle Type Settings:" },
			{
				type: "list",
				id: "particlesTexture",
				label: "Texture",
		...
		General: [
			{
				...
				max: 10,
				step: 0.5,
				onChange: value => setSetting("masterGain", value)
			},
			{
				type: "list",
				id: "soundfontName",
