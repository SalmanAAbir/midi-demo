...
class Loader {
	...
	getLoadingDiv() {
		if (!this.loadingDiv) {
			...
			this.loadingDiv.appendChild(DomHelper.createDiv({ flex: 3 }))
			this.loadingDiv.appendChild(logo)
			this.loadingDiv.appendChild(DomHelper.createDiv({ flex: 0.5 }))
			this.loadingDiv.appendChild(spinner)
			this.loadingDiv.appendChild(DomHelper.createDiv({ flex: 0.5 }))
			this.loadingDiv.appendChild(this.textDiv)
			this.loadingDiv.appendChild(DomHelper.createDiv({ flex: 2 }))
