export var CONST = {
	...
	DISTRIBUTIONS: {
		Y: {
			NOTE_TOP: "Top of note",
			ACROSS_NOTE: "Across note",
			NOTE_BOTTOM: "Bottom of note",
			KEYS_TOP: "Top of keys",
			ACROSS_KEYS: "Across keys",
			KEYS_BOTTOM: "Bottom of keys"
		},
		X: {
			ACROSS: "Across note",
			LEFT: "Left edge",
		...
		Z: {
			BEHIND_NOTES: "Behind notes",
			BEHIND_PIANO: "Behind Piano / front of notes",
			FRONT_OF_PIANO: "In front of piano"
		}
	},
	PARTICLE_TEXTURES: [
		"circle_01",
	...
	REVERBS: [
		//From http://www.echothief.com/downloads/
		"SteinmanHall",
		"MillsGreekTheater",
		"NaumburgBandshell",
		"Space4ArtGallery",
		...
		"BIG HALL E002 M2S",
		"BIG HALL E003 M2S",
		"Cenzo Celestion V30 Mix 200ms",
		"Cenzo Celestion V30 Mix 500ms",
		"STRANGEBOX-1",
		"ROBOTVERB-1",
		"WISSTLEPLATE-1",
		"REVGATEDDL1-1",
