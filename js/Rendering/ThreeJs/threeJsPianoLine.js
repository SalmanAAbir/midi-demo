...
import { getShader, SHADERS } from "./Shader.js"
import { getScene, getTheeJsColor } from "./threeJsHandler.js"
...
export class ThreeJsPianoLine {
	constructor() {
		...
		let uniforms = {
			time: { type: "f", value: 0 },
			screenWidth: { type: "f", value: getRenderDimensions().renderWidth },
			screenHeight: { type: "f", value: getRenderDimensions().renderHeight },
	...
	createShader() {
		...
		this.pianoLine = { point: this.point, start: window.performance.now() }
