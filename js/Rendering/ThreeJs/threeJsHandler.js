...
import { ThreeJsTextureManager } from "./TheeJsTextureManager.js"
...
export class ThreeJsHandler {
	...
	render(time = 10) {
		...
		if (!this.isParticlesCleared && !getSetting("showParticles")) {
			this.threeJsParticles.deleteAll()
			this.isParticlesCleared = true
			this.clearCnv()
		}
